    ...
    <section id="education" className="section-padding bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">Education & Research</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            My educational background and research focus have equipped me
            with the knowledge necessary for success in the computer science field.
          </p>
        </div>
